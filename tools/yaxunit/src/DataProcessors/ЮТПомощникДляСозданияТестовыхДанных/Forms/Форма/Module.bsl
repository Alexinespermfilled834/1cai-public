...
Процедура СформироватьКодДляКонструктораОбъектаНаСервере()
	...
	ПодготовленныеДанные = Обработки.ЮТПомощникДляСозданияТестовыхДанных.ПодготовленныеДанныеДляСозданияТестовогоОбъекта(СсылкаНаОбъект, Отмеченные, НастройкиФормирования);	
...
Процедура СформироватьКодДляКонструктораДвиженийНаСервере()
	...
	ПодготовленныеДанные = Обработки.ЮТПомощникДляСозданияТестовыхДанных.ПодготовленныеДанныеДляЗагрузкиДвижений(СсылкаНаОбъект, Отмеченные, НастройкиФормирования);	
