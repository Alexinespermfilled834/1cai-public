...
>
> **Если есть 30 секунд:**
> - откройте `makefile` — увидите живые сценарии запуска инфраструктуры, MCP и тестов;
> - загляните в `docs/architecture/uml/` — там PNG-диаграммы обновляются скриптами и совпадают с текущей архитектурой;
> - бегло посмотрите `docs/research/constitution.md` — это правила проверки, которыми мы руководствуемся, чтобы платформа не превращалась в хаос.
