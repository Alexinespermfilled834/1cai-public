...
### ▶️ Сценарий видеодемо установки (Nov 8, 2025)
...
- После записи ссылку на видео необходимо добавить в README/QUICKSTART и закрыть [issue #3](https://github.com/DmitrL-dev/1cai-public/issues/3)
