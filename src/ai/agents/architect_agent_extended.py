...
class ArchitectAgentExtended:
    ...
    async def analyze_architecture_graph(
        self, config_name: str, deep_analysis: bool = True
    ) -> Dict[str, Any]:
        """
        ...
        """
        logger.info("Starting graph analysis", extra={"config_name": config_name})
...
"""
    ...
    async def _save_adr(self, adr: Dict):
        ...
        logger.info("ADR saved", extra={"adr_id": adr["adr_id"]})
    ...
    async def detect_anti_patterns(
        self, config_name: str, include_code_analysis: bool = True
    ) -> Dict[str, Any]:
        """
        ...
        """
        logger.info("Detecting anti-patterns", extra={"config_name": config_name})
        ...
        return [
            {
                ...
                "estimated_days": self._estimate_refactoring_days(
    ...
    def _calculate_quality_score(self, anti_patterns: List[Dict]) -> float:
        ...
        severity_penalties = {"critical": 2.0, "high": 1.0, "medium": 0.5, "low": 0.2}
    ...
    def _prioritize_fixes(self, anti_patterns: List[Dict]) -> List[Dict]:
        ...
        return sorted(
            anti_patterns, key=lambda x: x.get("priority_score", 0), reverse=True
        )
