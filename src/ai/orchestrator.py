...
from src.monitoring.prometheus_metrics import scenario_requests_total, orchestrator_cache_hits_total, orchestrator_cache_misses_total

# Import extracted classifier
from src.ai.query_classifier import QueryClassifier, QueryType, AIService, QueryIntent
...
from src.ai.strategies.llm_providers import (
    GigaChatStrategy, YandexGPTStrategy, NaparnikStrategy, OllamaStrategy, TabnineStrategy
)
...
class AIOrchestrator:
    ...
    async def process_query(self, query: str, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        logger.info(f"Query classified: {intent.query_type.value}", extra={"confidence": intent.confidence})
