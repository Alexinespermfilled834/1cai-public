...
- Раздел `README.md → Что нового` обязан быть отсортирован по убыванию даты (последние изменения сверху).
- После успешного аудита делаем push **в оба** репозитория: `origin` и `public`.
